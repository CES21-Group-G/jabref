...
public class RightClickMenu {
    ...
    public static ContextMenu create(BibEntryTableViewModel entry,
        ...
        contextMenu.getItems().add(factory.createMenuItem(StandardActions.OPEN_EXTERNAL_FILE, new OpenMultipleExternalFilesAction(dialogService, stateManager, preferencesService)));
